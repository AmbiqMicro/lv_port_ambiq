...
__Vectors
        ...
        ;
; #### INTERNAL BEGIN ####
; Note - the latest IRQs can be found at mcu/digital_top/rtl/.build_nodsp/digital_top.v
; As of 11/14/19, no software interrupts are designated.
; #### INTERNAL END ####
...
; #### INTERNAL BEGIN ####
    IF :DEF: AM_APOLLO4_DSP
        DCD     am_dspmilli_isr             ; 41: dsp_milli_dspmilli_irq
    ELSE
; #### INTERNAL END ####
...
; #### INTERNAL BEGIN ####
    IF :DEF: AM_APOLLO4_DSP
        DCD     am_dsp0idamtrigout_isr      ; 52: DSP0IDMATRIGOUT
        DCD     am_dsp1idamtrigout_isr      ; 53: DSP1IDMATRIGOUT
        DCD     am_memcpy0_isr              ; 54: MEMCPYDMA0
    ELSE
; #### INTERNAL END ####
...
; #### INTERNAL BEGIN ####
    IF :DEF: AM_APOLLO4_DSP
        DCD     am_cpucpumb_isr             ; 64: CPU to CPU mailbox
        DCD     am_dsp0cpumb_isr            ; 65: DSP0 to CPU mailbox
        DCD     am_dsp1cpumb_isr            ; 66: DSP1 to CPU mailbox
    ELSE
; #### INTERNAL END ####
...
; #### INTERNAL BEGIN ####
    IF :DEF: AM_APOLLO4_DSP
                EXPORT  am_dsp0idamtrigout_isr      [WEAK]
                EXPORT  am_dsp1idamtrigout_isr      [WEAK]
                EXPORT  am_memcpy0_isr              [WEAK]
    ENDIF
; #### INTERNAL END ####
...
; #### INTERNAL BEGIN ####
    IF :DEF: AM_APOLLO4_DSP
                EXPORT  am_cpucpumb_isr             [WEAK]
                EXPORT  am_dsp0cpumb_isr            [WEAK]
                EXPORT  am_dsp1cpumb_isr            [WEAK]
    ENDIF
; #### INTERNAL END ####
...
; #### INTERNAL BEGIN ####
    IF :DEF: AM_APOLLO4_DSP
am_dsp0idamtrigout_isr
am_dsp1idamtrigout_isr
am_memcpy0_isr
    ENDIF
; #### INTERNAL END ####
am_gpio0_001f_isr
