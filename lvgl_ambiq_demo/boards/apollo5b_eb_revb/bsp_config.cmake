#******************************************************************************
# apollo5b_eb_revb BSP configuration
#******************************************************************************
...
# BSP includes
set(BSP_INCLUDES
    "${AMBIQSUITE_PATH}/boards/apollo5b_eb_revb/bsp"
)

# BSP sources
set(BSP_SOURCES
    "${AMBIQSUITE_PATH}/boards/apollo5b_eb_revb/bsp/am_bsp.c"
    "${AMBIQSUITE_PATH}/boards/apollo5b_eb_revb/bsp/am_bsp_pins.c"
    "${AMBIQSUITE_PATH}/CMSIS/AmbiqMicro/Source/system_apollo510.c"
)

# Device sources
set(DEVICE_SOURCES
    "${AMBIQSUITE_PATH}/devices/am_devices_mspi_psram_aps25616n.c"
